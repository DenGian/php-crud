...
<a style="color:purple; font-weight:bold; border:1px solid purple; text-decoration:none;" href="index.php?page=teacher">Teacher Page</a>
...
<form method="post">
    ...
    <button style="background-color:lightgreen; border:1px solid lightgreen; color:white; font-weight:bold;" name="submitNewCoach">Create!</button>
</form>
<p><?= $succes ?? 'STATUS'; ?></p>
